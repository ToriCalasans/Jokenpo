...
*/
  void _iniciar() {
    final movJogador = this.jogador.jogar();

    final movSeverino = this.severino.jogar();

    this.regras = [
      Empatar(jogada1: movJogador, jogada2: movSeverino),
      Vencer(jogada1: movJogador, jogada2: movSeverino),
    ];
